...
LINES = [
    ...
    ("01_cool", 3.9, "보기만 해도 시원하잖아…",
     "Dreamy and delighted, savoring the thought, a grin spreading — half whisper, half squeal."),
    ("01_imagine", 7.0, "여기에 맥주 딱 하면…",
     "Daydreaming out loud, mischievous and giddy, drawing out the fantasy."),
    ("01_kya", 11.2, "크으~",
     "The blissful 'kuh~' after an imaginary sip of cold beer — long, deeply satisfied, comic."),
    ("01_hook_b", 13.4, "5만 원…?",
