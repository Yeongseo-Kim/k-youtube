...
VOICE_DIR = Path("output/ep002/voice_eleven")   # ElevenLabs (xi3rF0t7dg7uN2M0WUhr)
...
SUBTITLES = [
    ("우와… 이 잔 뭐야…", 0.3, 1.6),
    ("보기만 해도 시원하잖아…", 1.8, 3.3),
    ("여기에 맥주 딱 하면…", 3.6, 5.0),
    ("크으~", 5.3, 5.9),
    ("5만 원…?", 7.7, 8.4),
    ("아무리 그래도 잔 하나에 5만 원은…", 8.9, 11.0),
    ("혹시… 인터넷?!", 11.8, 13.2),
    ("쿠팡 2만 원?! 아싸!", 13.5, 15.0),
    ("왔다…!", 17.0, 17.7),
    ("캬아~", 28.2, 28.8),
    ("기다린 보람이 있잖아~!", 29.3, 30.5),
    ("최고!", 31.3, 32.0),
]

# 강조 — 대사에 있는 단어만 키운다 (2만 원 반전): (텍스트, 시작, 끝, 크기, 색, y)
EMPHASIS = [
    ("2만 원?!", 13.5, 15.0, 76, "#F28C39", 500),
]

# 가격표 오버레이 — 상상에서 추락하는 1b 구간에 등장. 컷 확인 후 좌표 조정.
PRICE_TAG = ("₩50,000", 6.8, 8.6, 46, "white", 750)
...
SFX = [
    ("sfx_thud.mp3", 7.5),        # 가격 충격 "쿵" (상상 추락)
    ("sfx_dingdong.mp3", 15.4),   # 초인종
    ("sfx_dash.mp3", 19.8),       # 후다닥
    ("sfx_can_open.mp3", 21.5),   # 캔 칙-
    ("sfx_pour.mp3", 22.3),       # 따르는 소리
    ("sfx_sparkle.mp3", 31.3),    # 최고! 반짝
]
